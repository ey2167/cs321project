...
public class Schedule {
	...
	public static void main(String [] args)
	{
		...
		ConcreteRequirement a = new ConcreteRequirement("a",1,"aa",11);
		ConcreteRequirement b = new ConcreteRequirement("b",2,"bb",22);
		b.addPrerequisiteFor(a);
		ConcreteRequirement c = new ConcreteRequirement("c",3,"cc",33);
		c.addPrerequisiteFor(b);
		ConcreteRequirement d = new ConcreteRequirement("d",4,"dd",44);
		d.addPrerequisiteFor(c);
		ConcreteRequirement e = new ConcreteRequirement("e",5,"ee",55);
		e.addPrerequisiteFor(d);
		ConcreteRequirement f = new ConcreteRequirement("f",6,"ff",66);
		f.addPrerequisiteFor(e);
		ConcreteRequirement g = new ConcreteRequirement("g",7,"gg",77);
		g.addPrerequisiteFor(f);
		ConcreteRequirement h = new ConcreteRequirement("h",8,"hh",88);
		h.addPrerequisiteFor(a);
		ConcreteRequirement i = new ConcreteRequirement("i",9,"ii",99);
		i.addPrerequisiteFor(h);
		ConcreteRequirement j = new ConcreteRequirement("j",10,"jj",1010);
		ConcreteRequirement k = new ConcreteRequirement("k",11,"kk",1111);
		ConcreteRequirement l = new ConcreteRequirement("l",12,"ll",1212);
		ConcreteRequirement m = new ConcreteRequirement("m",13,"mm",1313);
		ConcreteRequirement n = new ConcreteRequirement("n",14,"nn",1414);
		ConcreteRequirement o = new ConcreteRequirement("o",15,"oo",1515);
		ConcreteRequirement p = new ConcreteRequirement("p",16,"pp",1616);
		ConcreteRequirement q = new ConcreteRequirement("q",17,"qq",1717);
		ConcreteRequirement t = new ConcreteRequirement("t",20,"tt",2020);
		ConcreteRequirement u = new ConcreteRequirement("u",21,"uu",2121);
		ConcreteRequirement v = new ConcreteRequirement("v",22,"vv",2222);
		ConcreteRequirement w = new ConcreteRequirement("w",23,"ww",2323);
		ConcreteRequirement x = new ConcreteRequirement("x",24,"xx",2424);
		ConcreteRequirement y = new ConcreteRequirement("y",25,"yy",2525);
		ConcreteRequirement z = new ConcreteRequirement("z",26,"zz",2626);
		//AbstractRequirement ab = new AbstractRequirement("Ab",5);
		/**
		 * 
		 */
		f.setFulfilled(true);
